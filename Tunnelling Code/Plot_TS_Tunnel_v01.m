...
cortical_Cyto_SOCE_p_pointer = Cyto_p(1,:) >= 548 & Cyto_p(1,:) <= 549 &...
    Cyto_p(2,:) >= 892 & Cyto_p(2,:) <= 893;
...
cortical_Cyto_1_p_pointer = Cyto_p(1,:) >= 1445 & Cyto_p(1,:) <= 1446 &...
    Cyto_p(2,:) >= 858 & Cyto_p(2,:) <= 859;
...
deep_Cyto_1_p_pointer = Cyto_p(1,:) >= 1200 & Cyto_p(1,:) <= 1201 &...
    Cyto_p(2,:) >= 151 & Cyto_p(2,:) <= 152;
...
writematrix(cal_point_traces, 'Fig_3_tunnelling_Ca_traces.csv')
