%% Mesh Generation for the Calcium Tunnelling Model with 2 Subdomains (Cytoplasm and ER)
...
ER_geom = [2; 14; 550; 1850; 1850; 620; 590; 650; 650; 450; 450; 560; 620; 1820; 1820; 550;
    200; 200; 800; 800; 860; 860; 885; 885; 860; 860; 770; 770; 400; 400];
% Full cell geom
...
ER_mesh = generateMesh(ER_model,'Hmax',Hmax_par,...
    'Hmin',Hmin_par,'Hedge',{[3 4 5 6 7 8 9 13 14],Hedge_par},...
...
Cyto_mesh = generateMesh(Cyto_model,'Hmax',Hmax_par,...
    'Hmin',Hmin_par,'Hedge',{[2 3 4 5 6 7 8 13 14],Hedge_par},...
    'Hgrad',Hgrad_par,'GeometricOrder','linear');
...
inter_bound_ER_e_pointer = (ER_e(5,:) == 1 | ER_e(5,:) == 3 | ER_e(5,:) == 4 |...
   ER_e(5,:) == 5 | ER_e(5,:) == 6 | ER_e(5,:) == 7 | ER_e(5,:) == 8 |...
    ER_e(5,:) == 9 | ER_e(5,:) == 11 | ER_e(5,:) == 12 |...
    ER_e(5,:) == 13 | ER_e(5,:) == 14);
...
inter_bound_Cyto_e_pointer = (Cyto_e(5,:) == 2 | Cyto_e(5,:) == 3 | Cyto_e(5,:) == 4 |...
    Cyto_e(5,:) == 5 | Cyto_e(5,:) == 6 | Cyto_e(5,:) == 7 | Cyto_e(5,:) == 8 |...
    Cyto_e(5,:) == 10 | Cyto_e(5,:) == 13 | Cyto_e(5,:) == 14 |...
    Cyto_e(5,:) == 15 | Cyto_e(5,:) == 18);
